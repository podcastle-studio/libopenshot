...
2. Whether the numeric gate for the current phase in `doc/GPU-RENDER-PLAN.md` section 3.1 is met.
...
commit the JSON under `tests/bench/results/`, and update `STATUS.md`.
